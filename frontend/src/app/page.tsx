  ...
  const launch = async () => {
    ...
    try {
      ...
      const body = isRedMode
        ? { provider, dataset_path: datasetPath, task_description: task, persona_names: ALL_PERSONA_HANDLES }
        : { provider, dataset_path: datasetPath, task_description: task }
    ...
    <>
      ...
      >
        ...
        <div style={{ padding: '16px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span className="mono" style={{ fontSize: 10 }}>HACKME v2.0</span>
